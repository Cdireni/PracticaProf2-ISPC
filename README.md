...
* 🧹 **Limpieza:** Tratamiento de nulos, eliminación de duplicados y casteos de tipos de datos (fechas y numéricos).
* 🚫 **Outliers:** Detección y manejo mediante rangos intercuartílicos (IQR).
* 📈 **Análisis Exploratorio (EDA):** Visualizaciones univariadas y bivariadas. Destaca la creación de la *Matriz de Correlación S.I.M.A.*, donde se comprobó la relación inversa entre humedad y temperatura en algunas localidades.
